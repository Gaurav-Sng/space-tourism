...
moon.addEventListener("click", () => {
  ...
  destination.src = "../starter-code/assets/destination/image-moon.png";
});
...
europa.addEventListener("click", () => {
  ...
  destination.src = "../starter-code/assets/destination/image-europa.png";
});
titan.addEventListener("click", () => {
  ...
  destination.src = "../starter-code/assets/destination/image-titan.png";
});
mars.addEventListener("click", () => {
  ...
  destination.src = "../starter-code/assets/destination/image-mars.png";
});
